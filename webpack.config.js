...
Encore
    ...
    .addStyleEntry(
        "nosRealisationsStyle",
        "./public/theme/transvis/css/nosRealisations.css"
    )
    .addStyleEntry(
        "recrutementStyle",
        "./public/theme/transvis/css/recrutement.css"
    )
    .addStyleEntry(
        "blockTopStyle",
        "./public/theme/transvis/css/blockTopWithImage.css"
    )
    .addStyleEntry(
        "homeHeaderStyle",
        "./public/theme/transvis/css/homeHeader.css"
    )
    .addStyleEntry(
        "homeNosValeursStyle",
        "./public/theme/transvis/css/homeNosValeurs.css"
    )
    .addStyleEntry(
        "splideStyle",
        "./public/theme/transvis/css/dependency/splide.min.css"
    )
    .addStyleEntry(
        "logoSliderStyle",
        "./public/theme/transvis/css/components/logoSlider.css"
    )
    .addStyleEntry(
        "recrutementsNumberStyle",
        "./public/theme/transvis/css/components/recrutementsNumber.css"
    )
    .addStyleEntry(
        "bannerKeyStyle",
        "./public/theme/transvis/css/bannerKeyFigures.css"
    )
    .addStyleEntry(
        "buttonFilterStyle",
        "./public/theme/transvis/css/components/buttonFilter.css"
    )

    .addStyleEntry("btnRedStyle", "./public/theme/transvis/css/btnRed.css")
    .addStyleEntry("tagStyle", "./public/theme/transvis/css/tag.css")
    .addStyleEntry(
        "cardNosRealisationStyle",
        "./public/theme/transvis/css/components/cardNosRealisations.css"
    )
    .addStyleEntry(
        "cardRecrutementStyle",
        "./public/theme/transvis/css/cardRecrutement.css"
    )
    ...
    .addStyleEntry(
        "paginationStyle",
        "./public/theme/transvis/css/components/pagination.css"
    )
    .addStyleEntry(
        "videoModalStyle",
        "./public/theme/transvis/css/components/videoModal.css"
    )
    /* SCRIPT */
    .addEntry("appJs", "./public/theme/transvis/js/app.js")
    .addEntry(
        "bootstrapJs",
        "./public/theme/transvis/js/dependency/bootstrap.min.js"
    )
    ...
    .addEntry(
        "keyFiguresJs",
        "./public/theme/transvis/js/_keyFigures/keyAnimate.js"
    )
...
if (Encore.isProduction()) {
    Encore.addPlugin(
        new PurgeCssPlugin({
            paths: glob.sync([
                path.join(__dirname, "/public/theme/transvis/*.twig"),
                path.join(__dirname, "/public/theme/transvis/partials/*.twig"),
                path.join(__dirname, "/public/theme/transvis/partials/**/*.twig"
                ),
            ]),
            content: ["*.twig"],
